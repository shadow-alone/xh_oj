...
-- 创建库
create database if not exists xhoj_db;
...
(
    ...
    judegeCase  text                              null comment '判题用例（json数组）',
    judegeConfig  text                            null comment '判题配置（json 对象）',
...
(
    ...
    status        int  default 0                      null comment '判题状态',
